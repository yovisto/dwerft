...
public class RdfProcessor {
	...
	public void linkDatatypeProperty(Node node, MappingDefinition mapping) {
		...
		if (mapping.getContentSource().equals(MappingDefinition.ContentSource.ATTRIBUTE)) {
			value = XMLProcessor.getValueOfAttribute(node, mapping.getContentElementName());
		} else 
		if (mapping.getContentSource().equals(MappingDefinition.ContentSource.TEXT_CONTENT)) {
...
//		} else {
	...
	public void linkObjectProperty(Node node, MappingDefinition mapping) {
		...
		if (mapping.getContentSource().equals(MappingDefinition.ContentSource.CONTAINMENT)) {
		...
		if (mapping.getContentSource().equals(MappingDefinition.ContentSource.REFERENCE)) {
	...
	public Resource createRDF(Node node, MappingDefinition mapping) {
		...
		if (mapping.getTargetOntologyProperty() != null && mapping.getTargetPropertyType().equals(MappingDefinition.TargetPropertyType.OBJECT_PROPERTY)) {
